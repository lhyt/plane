...
function bindEvent() {
  ...
  $body.on('click', '.js-start', function() {
    ...
    // 开始游戏 
    setTimeout(function(){GAME.end()},90000)
    GAME.start();
  ...
  //点击难度
  $body.on('click', '.js-nan', function() {
    $body.attr('data-status', 'nan');
  });
...
//console
  ...
  createEnemy: function(enemyType) {
    ...
    var theLastTime=0.15*(new Date()- theFirstTime);
    theLastTime=400*Math.round(theLastTime/100);
    alert('你的分数是:'+theLastTime);
    theFirstTime=0;
  },
  draw: function() {
